...
CREATE TABLE products(
	...
	first_near_latitudine DOUBLE NOT NULL,
	first_near_longitude DOUBLE NOT NULL,
	first_far_latitudine DOUBLE NOT NULL,
	first_far_longitude DOUBLE NOT NULL,
	last_near_latitudine DOUBLE NOT NULL,
	last_near_longitude DOUBLE NOT NULL,
	last_far_latitudine DOUBLE NOT NULL,
	last_far_longitude DOUBLE NOT NULL,
	geo_boundary VARCHAR(1500) NOT NULL
)
;

CREATE TABLE product_repository_attributes(
	id INTEGER NOT NULL PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
