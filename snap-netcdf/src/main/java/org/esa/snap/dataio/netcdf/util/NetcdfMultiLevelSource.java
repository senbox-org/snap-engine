...
public class NetcdfMultiLevelSource extends LazyMultiLevelSource {
   ...
   */
  public NetcdfMultiLevelSource(RasterDataNode rdn, Variable variable, ProfileReadContext ctx) {
   ...
   * @param ctx         the context
   */
  public NetcdfMultiLevelSource(RasterDataNode rdn, Variable variable, int[] imageOrigin, ProfileReadContext ctx) {
    super(rdn);
