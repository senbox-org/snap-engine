...
public class ColorBarLayer extends Layer {
    ...
    public void renderLayer(Rendering rendering) {
        if (graticule == null) {
            graticule = ColorBar.create(raster,
                                         getResAuto(),
                                         getResPixels(),
                                         (float) getResLat(),
                                         (float) getResLon());
        ...
        if (graticule != null) {
            ...
            try {
                ...
                if (isTextEnabled()) {
                    final ColorBar.TextGlyph[] textGlyphs = graticule.getTextGlyphs();
                    if (textGlyphs != null) {
    ...
    private void drawTextLabels(Graphics2D g2d, final ColorBar.TextGlyph[] textGlyphs) {
        final float tx = 3;
        final float ty = -3;
