...
public class GeneralFilterBandPersistenceSpi implements PersistenceSpi {

    private static final GeneralFilterBandPersistenceConverter CONVERTER = new GeneralFilterBandPersistenceConverter();
