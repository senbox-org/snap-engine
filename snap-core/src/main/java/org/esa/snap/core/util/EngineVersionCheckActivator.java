...
public class EngineVersionCheckActivator implements Activator {
    ...
    private static final String MSG_UPDATE_INFO = "A new " + SystemUtils.getApplicationName() + " version is available for download.\nCurrently installed %s, available is %s.\nPlease visit %s\n";
    private static final VersionChecker VERSION_CHECKER = VersionChecker.getInstance();
    private static boolean hasChecked = false;

    @Override
    public void start() {
        SystemUtils.LOG.log(Level.INFO, "Please check regularly for new updates for the best " + SystemUtils.getApplicationName() + " experience.");
