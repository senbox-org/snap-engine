...
public class GcpGeoCodingPersistenceSpi implements PersistenceSpi {

    private static final GcpGeoCodingPersistenceConverter CONVERTER = new GcpGeoCodingPersistenceConverter();
    ...
    public boolean canEncode(Object object) {
        return object instanceof GcpGeoCoding;
    }
