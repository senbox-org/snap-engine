...
public class ColorBarLayerType extends LayerType {
    ...
    public static final String PROPERTY_NAME_RES_AUTO = "colorbar.res.auto";
    public static final String PROPERTY_NAME_RES_PIXELS = "colorbar.res.pixels";
    public static final String PROPERTY_NAME_RES_LAT = "colorbar.res.lat";
    public static final String PROPERTY_NAME_RES_LON = "colorbar.res.lon";
    public static final String PROPERTY_NAME_LINE_COLOR = "colorbar.line.color";
    public static final String PROPERTY_NAME_LINE_TRANSPARENCY = "colorbar.line.transparency";
    public static final String PROPERTY_NAME_LINE_WIDTH = "colorbar.line.width";
    public static final String PROPERTY_NAME_TEXT_ENABLED = "colorbar.text.enabled";
    public static final String PROPERTY_NAME_TEXT_FONT = "colorbar.text.font";
    public static final String PROPERTY_NAME_TEXT_FG_COLOR = "colorbar.text.fg.color";
    public static final String PROPERTY_NAME_TEXT_BG_COLOR = "colorbar.text.bg.color";
    public static final String PROPERTY_NAME_TEXT_BG_TRANSPARENCY = "colorbar.text.bg.transparency";
