 ...
 * @since SNAP 9.0
 */
public class RangeTypeMaskPersistenceSpi implements PersistenceSpi {

    private static final RangeTypeMaskPersistenceConverter CONVERTER = new RangeTypeMaskPersistenceConverter();
