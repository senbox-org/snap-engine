 ...
 * @since SNAP 9.0
 */
public class VectorDataMaskPersistableSpi implements DimapPersistableSpi {

    @Override
    public boolean canDecode(Element element) {
        final String type = element.getAttributeValue(DimapProductConstants.ATTRIB_TYPE);
        return Mask.VectorDataType.TYPE_NAME.equals(type);
    }
    ...
    public DimapPersistable createPersistable() {
        return new VectorDataMaskPersistable();
    }
}
