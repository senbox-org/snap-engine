...
public class TiePointGridPointingTest {
    ...
    public void testEqualsAndHashcode() {
        ...
        // test equals
        assertEquals(tiePointGridPointing1, tiePointGridPointing2);
        assertNotEquals(tiePointGridPointing1, tiePointGridPointing3);

        // test hashCode
        assertEquals(tiePointGridPointing1.hashCode(), tiePointGridPointing2.hashCode());
        assertNotEquals(tiePointGridPointing1.hashCode(), tiePointGridPointing3.hashCode());
        ...
        assertNull(map.get(tiePointGridPointing3));
    }
}
