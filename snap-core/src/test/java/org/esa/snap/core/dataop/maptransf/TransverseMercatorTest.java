...
public class TransverseMercatorTest {
    ...
    private final double _geodeticDelta = 0.001; // accuracy = 0.001 degree
    private final double _metricDelta = 0.01;    // accuracy = 0.01 meter = 1 centimeter

    private final double[][] _srcCoords = {{-60.0, -10.0}, // !! is in LON/LAT order!!!!
            {-50.0, -9.0},
            {-40.0, -8.0},
            {-30.0, -7.0},
            {-20.0, -6.0},
    ...
    private final double[][] _targCoords = {{-8068822.8, -2130949.9},
...
//};
    ...
    public void testCartographicMapTransformParameterSettings() {
        ...
        assertEquals(Ellipsoid.WGS_84.getSemiMajor(), amt.getSemiMajor(), 1e-10);
