...
public class TestData {
    ...
    public static GeoRaster get_MER_RR() {
        return new GeoRaster(MERIS.MER_RR_LON, MERIS.MER_RR_LAT, "longitude", "latitude", 5, 5,
    ...
    public static GeoRaster get_OLCI() {
        return new GeoRaster(OLCI.OLCI_L2_LON, OLCI.OLCI_L2_LAT, "longitude", "latitude", 32, 36,
    ...
    public static GeoRaster get_FlatEarth() {
        ...
        return new GeoRaster(longitudes, latitudes, "lon", "lat", 10, 10, 10, 10, 0.3, 0.5, 0.5, 1.0, 1.0);
    }
