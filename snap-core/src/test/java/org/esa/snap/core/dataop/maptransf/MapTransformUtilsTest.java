...
public class MapTransformUtilsTest {

    private final double[] _exc1 = new double[]{1.1, 1.0, 0.95, 0.9, 0.85, 0.8};
    private final double[] _exc2 = new double[]{0.006, 0.012, 0.003, 0.0001, 0.024, 0.03};
    private final double[] _args = new double[]{0.71, -0.34, 0.56, -0.78, 1.23, -1.44};
    private final double[] _expInvLength = new double[]{0.71330055126015,
            -0.34389100235832,
            0.56143567897512,
            -0.78005700057606,
            1.2430448502071,
            -1.4536210890449};
    private final double[][] _expLengthParams = new double[][]{
