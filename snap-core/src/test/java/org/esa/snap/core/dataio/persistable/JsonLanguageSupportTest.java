...
public class JsonLanguageSupportTest {

    private MarkupLanguageSupport<Map<String, Object>> support;

    @Before
    public void setUp() throws Exception {
        support = new JsonLanguageSupport();
    }
    ...
    public void testSingleValueProperties() throws JsonProcessingException {
        ...
        //execution
        final List<Map<String, Object>> objects = support.toLanguageObjects(items1);
        final List<Item> items2 = support.convertToItems(objects);

        //verification
        final String out = jsonOut(objects);
    ...
    public void testArrayValueProperties() throws JsonProcessingException {
        ...
        //execution
        final List<Map<String, Object>> elements = support.toLanguageObjects(items1);
        final List<Item> items2 = support.convertToItems(elements);

        //verification
        final String out = jsonOut(elements);
        assertThat(out).contains(
...
//                        .isEqualTo(new String[]{"a", "b", "c"});
    ...
    public void testContainer() throws JsonProcessingException {
        ...
        //execution
        final List<Map<String, Object>> elems1 = support.toLanguageObjects(items1);
        final List<Item> items2 = support.convertToItems(elems1);
        final List<Map<String, Object>> elems2 = support.toLanguageObjects(items2);

        //verification
        final String out1 = jsonOut(elems1);
        final String out2 = jsonOut(elems2);
