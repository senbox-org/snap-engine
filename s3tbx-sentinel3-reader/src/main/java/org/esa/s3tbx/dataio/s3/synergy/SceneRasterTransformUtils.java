...
public class SceneRasterTransformUtils {
     ...
     */
    public static PixelPos transformToProductRaster(SynergyL1CBand rasterDataNode, PixelPos orig) throws SceneRasterTransformException {
     ...
     * @throws SceneRasterTransformException When the transformation could not be applied
     */
    public static PixelPos transformToRasterDataNodeRaster(SynergyL1CBand rasterDataNode, PixelPos orig) throws SceneRasterTransformException {
        final SceneRasterTransform sceneRasterTransform = rasterDataNode.getSceneRasterTransform();
        if(sceneRasterTransform == SceneRasterTransform.IDENTITY) {
            return orig;
        }
     ...
     * @throws SceneRasterTransformException When the transformation could not be applied
     */
    public static PixelPos transformFromToRasterDataNodeRaster(SynergyL1CBand from, SynergyL1CBand to, PixelPos orig) throws SceneRasterTransformException {
     ...
     * @throws SceneRasterTransformException When the transformation could not be applied
     */
    public static Shape transformToProductRaster(SynergyL1CBand rasterDataNode, Shape orig) throws SceneRasterTransformException {
     ...
     * @throws SceneRasterTransformException When the transformation could not be applied
     */
    public static Shape transformToRasterDataNodeRaster(SynergyL1CBand rasterDataNode, Shape orig) throws SceneRasterTransformException {
     ...
     * @throws SceneRasterTransformException When the transformation could not be applied
     */
    public static Shape transformFromToRasterDataNodeRaster(SynergyL1CBand from, SynergyL1CBand to, Shape orig) throws SceneRasterTransformException {
        return transformToRasterDataNodeRaster(to, transformToProductRaster(from, orig));
    }
