...
public class SceneRasterTransformUtilsTest {
    ...
    private SynergyL1CBand band2;
    private SynergyL1CBand band1;
    private Product product;
    private SynergyL1CBand band3;
    ...
    public void setUp() {
        ...
        band1 = new SynergyL1CBand("B1", ProductData.TYPE_INT16, 4, 8, "X");
        band2 = new SynergyL1CBand("B2", ProductData.TYPE_INT16, 8, 16, "Y");
        ...
        band3 = new SynergyL1CBand("B3", ProductData.TYPE_INT16, 2, 4, "Y");
    ...
    public void testTransformFromToRasterGrid_PixelPos() throws TransformException, SceneRasterTransformException {
        ...
        SynergyL1CBand band4 = new SynergyL1CBand("B4", ProductData.TYPE_INT16, 3, 10, "X");
...
//        band2.setGeoCoding(new TiePointGeoCoding(lat2, lon2));
    ...
    public void testTransformFromToRasterGrid_Shape() throws TransformException, SceneRasterTransformException {
        ...
        product.addTiePointGrid(lat3);
        product.addTiePointGrid(lon3);
        SynergyL1CBand band1 = new SynergyL1CBand("B1", ProductData.TYPE_INT16, 6, 12, "X");
        SynergyL1CBand band2 = new SynergyL1CBand("B2", ProductData.TYPE_INT16, 4, 8, "Y");
        product.addBand(band1);
        product.addBand(band2);
