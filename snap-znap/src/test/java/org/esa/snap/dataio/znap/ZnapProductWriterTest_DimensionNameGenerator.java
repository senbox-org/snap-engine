...
public class ZnapProductWriterTest_DimensionNameGenerator {

    private ZnapProductWriter.DimensionNameGenerator generator;

    @Before
    public void setUp() throws Exception {
        generator = new ZnapProductWriter.DimensionNameGenerator();
    }
