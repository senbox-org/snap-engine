...
public class ZnapProductWriterTest_createCfConformSampleCodingAttributes {
    ...
    public void noSampleCoding() {
        ...
        ZnapProductWriter.collectBandAttributes(band, cfConformSampleCodingAttributes);
    ...
    public void indexCoding() {
        ...
        ZnapProductWriter.collectSampleCodingAttributes(band, cfConformSampleCodingAttributes);
    ...
    public void indexCoding_noOrEmptyDescription() {
        ...
        ZnapProductWriter.collectSampleCodingAttributes(band, this.cfConformSampleCodingAttributes);
