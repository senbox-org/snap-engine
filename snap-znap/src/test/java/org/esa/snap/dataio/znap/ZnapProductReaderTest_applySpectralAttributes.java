...
public class ZnapProductReaderTest_applySpectralAttributes {

    private Band sourceBand;
    private Map<String, Object> attributes;
    private Band targetBand;
    private ZnapProductReader reader;
    ...
    public void setUp() throws Exception {
        ...
        reader = new ZnapProductReader(new ZnapProductReaderPlugIn());
    }
    ...
    public void applySpectralBandwidth() {
        ...
        ZnapProductWriter.collectBandAttributes(sourceBand, attributes);
