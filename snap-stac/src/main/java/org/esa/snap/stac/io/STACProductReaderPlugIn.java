    ...
    public DecodeQualification getDecodeQualification(final Object input) {
        ...
        if (path != null) {
            try {
                ...
                if (realName.endsWith(METADATA_EXT)) {
                    return StacItem.isStacItem(path) ? DecodeQualification.SUITABLE : DecodeQualification.UNABLE;
                }
            } catch (Exception e) {
    ...
    public static class FileFilter extends SnapFileFilter {
        ...
        public boolean accept(final File file) {
            if (super.accept(file)) {
                ...
                return file.isDirectory() || filename.endsWith(METADATA_EXT);
            }
            return false;
        }
    }
