...
@ActionReference(path = "Menu/Optical/Preprocessing/IdePix Pixel Classification", position = 300)
...
public class IdepixMerisAction extends AbstractSnapAction {
    ...
    public IdepixMerisAction() {
        setHelpId("idepix");
        putValue(Action.SHORT_DESCRIPTION, "Performs pixel classification on a MERIS L1b data product.");
    }
