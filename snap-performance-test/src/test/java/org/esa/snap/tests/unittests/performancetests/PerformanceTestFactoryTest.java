...
public class PerformanceTestFactoryTest {
    ...
    public void createPerformanceTest() {
        ...
        Parameters params4 = new Parameters("write-single-product","","",false, Threading.SINGLE, 12);
        Parameters params5 = new Parameters("Write-Single-PRODUCT","","",false, Threading.SINGLE, 12);
        Parameters params6 = new Parameters("writesingleproduct","","",false, Threading.SINGLE, 12);
