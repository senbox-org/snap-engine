...
public class MyParameters {
    ...
    public MyParameters(String testName, String productName, String testDirectory, String outputDir, boolean discardFirstMeasure, Threading threading, int numExecutionsForAverageOperations) {
