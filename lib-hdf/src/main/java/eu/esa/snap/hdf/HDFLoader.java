...
public class HDFLoader implements Activator {
    ...
    private static final String H5_CLASS_NAME = "hdf.hdf5lib.H5";
...
//        final ClassLoader classLoader = HDFLoader.class.getClassLoader();
//        final String classResourceName = "/" + HDFLoader.H5_CLASS_NAME.replace('.', '/') + ".class";
//        if (HDFLoader.class.getResource(classResourceName) != null) {
//            try {
//                Class.forName(HDFLoader.H5_CLASS_NAME, true, classLoader);
//                return true;
