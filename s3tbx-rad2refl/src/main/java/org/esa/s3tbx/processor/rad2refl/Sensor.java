...
public enum Sensor {
    ...
    SLSTR("SLSTR", SLSTR_NUM_SPECTRAL_BANDS, SLSTR_RAD_BAND_NAMES, SLSTR_REFL_BAND_NAMES,
    ...
    Sensor(String name, int numSpectralBands, String[] radBandNames, String[] reflBandNames,
           String[] solarFluxBandNames, String[] szaBandNames, String radAutogroupingString, String reflAutogroupingString) {
        this.name = name;
